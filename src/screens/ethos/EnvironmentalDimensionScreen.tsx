...
const EnvironmentalDimensionScreen: React.FC<{navigation: any}> = ({
  ...
  const onNextPress = () => {
    if (selectedCard) {
      ...
      navigation.navigate('EmotionalDimension');
    }
  };
    ...
    <LinearGradient colors={['#fff', '#F0F3F4']} style={styles.flex1}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.majorText}>
          Choose the Ethos that guides your environmental dimension of life.
        </Text>
        <Text style={styles.minorText}>
          These are the places and spaces
          <Text style={styles.gray3}> you occupy</Text>
        </Text>
...
export default EnvironmentalDimensionScreen;
