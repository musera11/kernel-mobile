...
const PhysicalDimensionScreen: React.FC<{navigation: any}> = ({navigation}) => {
  ...
  const onNextPress = () => {
    if (selectedCard) {
      ...
      navigation.navigate('MentalDimension');
    }
  };
    ...
    <LinearGradient colors={['#fff', '#F0F3F4']} style={styles.flex1}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.majorText}>
          Choose the Ethos card that guides your physical dimension of life
        </Text>
        <Text style={styles.minorText}>
          This about your vehicle through life
          <Text style={styles.gray3}> - YOUR BODY</Text>
        </Text>
...
export default PhysicalDimensionScreen;
