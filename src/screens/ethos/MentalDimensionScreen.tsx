...
const MentalDimensionScreen: React.FC<{navigation: any}> = ({navigation}) => {
  ...
  const onNextPress = () => {
    if (selectedCard) {
      ...
      navigation.navigate('SocialDimension');
    }
  };
  ...
  return (
    <LinearGradient colors={['#fff', '#F0F3F4']} style={styles.flex1}>
      <View style={styles.container}>
        ...
        <Text style={styles.minorText}>MENTAL DIMENSION</Text>
...
export default MentalDimensionScreen;
