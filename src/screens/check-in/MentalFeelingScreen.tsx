...
const MentalFeelingScreen: React.FC<{navigation: any}> = ({navigation}) => {
  ...
  const onContinuePress = () => {
    dispatch(addFeeling({dimension: 'MENTAL', value: sliderValue}));
    navigation.navigate('SocialFeeling');
  };
    ...
    <LinearGradient colors={['#72CCD0', '#87BCBF']} style={styles.flex1}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
        ...
        <Text style={styles.majorText}>
          {' '}
          <Text style={styles.darkText}>mental</Text> dimension of life
        </Text>
        <EmojiAndText sliderValue={sliderValue} dimension="MENTAL" />
...
export default MentalFeelingScreen;
